        ...
        <div class="card col-lg-8">
            <div class="card-body">
                <form action="/tambah-data" method="POST">
                    ...
                    <select class="form-select form-select-sm custom-dropdown" aria-label="Small select example"
                        name="lokasi">
                        @if (old('lokasi') != null)
                            <option value="{{ old('lokasi') }}">{{ old('lokasi') }}</option>
                        @endif
                    ...
                    <label class="mt-3" for="created_at">Tanggal</label>
                    <input type="date" class="form-control" id="created_at" value="{{ old('created_at') }}"
                        name="created_at">

                    <div class="card-title">Harga Barang</div>
                    <label for="beras-premium">Beras Premium</label>
                    <input type="number" class="form-control" id="beras-premium" value="{{ old('beras_premium') }}"
                        name="beras_premium">

                    <label class="mt-3" for="beras-medium">Beras Medium</label>
                    <input type="number" class="form-control" id="beras-medium" value="{{ old('beras_medium') }}"
                        name="beras_medium">
                    ...
                    <input type="number" class="form-control" id="daging_sapi_murni"
                        value="{{ old('daging_sapi_murni') }}" name="daging_sapi_murni">
                    ...
                    <label class="mt-3" for=" indomi_ayam_bawang">Indomie Ayam Bawang</label>
                    <input type="number" class="form-control" id=" indomi_ayam_bawang"
                        value="{{ old(' indomi_ayam_bawang') }}" name=" indomi_ayam_bawang">
